<template>
    <header class="bg-darkgray text-white h-20 sm:h-30 w-full flex flex-row items-center">
        <div class="flex h-20 sm:h-30 w-full">
            <img class="py-2 ml-5" src="/src/assets/logo.png">
        </div>

        <div @click="activeDropDown = !activeDropDown" class="relative w-full justify-end flex mr-4 sm:text-lg">
