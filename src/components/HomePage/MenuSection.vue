<template>
    <div class="h-fit bg-darkgray">
        <h1 class="text-white text-2xl font-bold text-center pt-8">Menu</h1>
        <hr class="mx-auto w-8 h-2 bg-amber-500 border-0 rounded-sm">

        <div class="flex flex-col py-10 text-white text-lg gap-5">
            <button @click="category = 'pizza'"  class="font-bold mx-auto w-fit shadow-black shadow-2xl px-25 py-3 transition active:scale-110 active:-translate-y-4">Pizza</button>
            <button @click="category = 'appetizers'"  class="font-bold mx-auto w-fit shadow-black shadow-2xl px-25 py-3 transition active:scale-110 active:-translate-y-4">Appetizer</button>
            <button @click="category = 'drinks'"  class="font-bold mx-auto w-fit shadow-black shadow-2xl px-25 py-3 transition active:scale-110 active:-translate-y-4">Drinks</button>
        </div>

        <!-- Pizzas div -->
        <div v-if="category == 'pizza' || category == null"   class="flex flex-col gap-10">
        ...
        <!-- Appetizers div -->
        <div v-if="category == 'appetizers'" class="flex flex-col gap-10">
        ...
        <!-- Drinks div -->
        <div v-if="category == 'drinks'" class="flex flex-col gap-10">
...
const pizzas = [
    {
        name: 'Margherita',
        imgSrc: '/src/assets/images/pizzas/margherita.jpg',
    ...
    {
        name: 'Marinara',
        imgSrc: '/src/assets/images/pizzas/marinara.png',
    ...
    },
    {
        ...
        imgSrc: '/src/assets/images/pizzas/4stagioni.png',
...
const appetizers = [
    ...
    {
        name: 'Caprese',
        imgSrc: '/src/assets/images/appetizers/caprese.jpg',
    ...
    },
    {
        ...
        imgSrc: '/src/assets/images/appetizers/antipastoDiMare.png',
...
const drinks = [
    {
        name: 'Water',
        imgSrc: '/src/assets/images/drinks/water.png',
        price: 1.50
    },
    {
        name: 'Beer',
        imgSrc: '/src/assets/images/drinks/beer.png',
        price: 4.00
    },
    {
        name: 'CocaCola',
        imgSrc: '/src/assets/images/drinks/cocacola.png',
        price: 2.50
    },
    {
        name: 'Fanta',
        imgSrc: '/src/assets/images/drinks/fanta.png',
        price: 2.50
    },
    {
        name: 'Sprite',
        imgSrc: '/src/assets/images/drinks/sprite.png',
        price: 2.50
    }
]
